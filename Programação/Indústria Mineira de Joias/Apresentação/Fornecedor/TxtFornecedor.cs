...
using Apresentação.Álbum.Edição;


namespace Apresentação.Formulários.Fornecedor
{
	public class TxtFornecedor : System.Windows.Forms.UserControl
	{
		...
		private void ConstruirListView()
		{
			...
			lst.AoSelecionarFornecedor += new ListViewFornecedor.SeleçãoFornecedor(lst_AoSelecionarFornecedor);
		...
		public Entidades.Fornecedor ObterFornecedor()
		{
            return Entidades.Fornecedor.ObterFornecedorPorNome(txt.Text.Trim());
		}
