    ...
    public class Aplicação : System.Windows.Forms.ApplicationContext
    {
        ...
        public Aplicação(Type tipoFormulário, Usuários usuários, bool efetuarLogin, Splash splash)
        {
...
#endif
            {
                ...
                if (splash != null)
                    splash.Mensagem = "Garimpando o ouro...";
        ...
        void AoRegistrarErro(Usuário usuário, Exception e)
        {
#if DEBUG
...
#if DEBUG
        private void AoCriarConexão(Usuário usuário)
        {
