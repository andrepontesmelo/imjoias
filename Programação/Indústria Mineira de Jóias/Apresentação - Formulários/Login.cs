...
namespace Apresentação.Formulários
{
	...
	public sealed class Login : Apresentação.Formulários.JanelaExplicativa
	{
        ...
        public static bool ExigirIdentificação(IWin32Window owner, Permissão privilégios, Pessoa autorizada, string título, string recurso, string descrição)
        {
            using (Login dlg = new Login())
            {
                ...
                dlg.picÍcone.Image = Properties.Resources.cadeado_aberto;
