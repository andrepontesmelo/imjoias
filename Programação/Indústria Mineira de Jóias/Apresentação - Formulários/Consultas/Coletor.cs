...
namespace Apresentação.Formulários.Consultas
{
	...
	{
		// Constantes
		private const int		tempoEsperaAlteraçãoInicial = 200;		// milissegundo
		private const int		tempoEsperaAlteraçãoMáximo  = 900;		// milissegundo
        ...
        private void LoopRecuperação()
        {
            ...
            do
            {
                ...
                {
                    alterada = false;
                    Thread.Sleep(CalcularTempoEsperaAlteração());
                }
