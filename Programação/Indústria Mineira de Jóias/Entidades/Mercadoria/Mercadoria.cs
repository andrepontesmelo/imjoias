...
namespace Entidades.Mercadoria
{
	...
	public class Mercadoria : Acesso.Comum.DbManipulação, IDisposable, ICloneable
	{
        ...
        //        {
        //            if (!((MercadoriaCamposLeve)campos).Preparado)
        //                return false;
        //        }

        //        if (campos.DePeso)
        //            return íconeJáObtido;
        //        else
        ...
        ///// <summary>
        ///// Preparar ícone da mercadoria.
        ///// </summary>
        //public void PrepararÍcone()
        //{
        //    if (!peso.HasValue && campos is MercadoriaCampos)
        //        campos.PrepararÍcone();
        //    else if (!íconeJáObtido)
        //        RecuperarÍcone();
        //}

        ///// <summary>
        ///// Recupera ícone da mercadoria.
        ///// </summary>
        //private void RecuperarÍcone()
        //{
        //    Álbum.Ícone i = Álbum.Ícone.ObterÍcone(ReferênciaNumérica, peso);
        ...
        //        Image ícone = this.icone;

        //        if (ícone == null)
        //            return;

        //        Bitmap bmp = new Bitmap(Ícone.Width, Ícone.Height, System.Drawing.Imaging.PixelFormat.Format32bppRgb);

        //        using (Graphics g = Graphics.FromImage(bmp))
        //        {
        //            g.FillRectangle(new SolidBrush(SystemColors.Window), 0, 0, bmp.Width, bmp.Height);
        ...
        //        //        if (pixel.A == 0)
        //        //            bmp.SetPixel(x, y, SystemColors.Window);
        //        //        else if (pixel.A < 255)
        //        //        {
        //        //            int r, g, b;

        //        //            r = (pixel.R * pixel.A + SystemColors.Window.R * (255 - pixel.A)) / 255;
        //        //            g = (pixel.G * pixel.A + SystemColors.Window.G * (255 - pixel.A)) / 255;
        //        //            b = (pixel.B * pixel.A + SystemColors.Window.B * (255 - pixel.A)) / 255;
