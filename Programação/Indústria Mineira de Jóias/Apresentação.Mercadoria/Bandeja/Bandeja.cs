...
namespace Apresentação.Mercadoria.Bandeja
{
	...
	public class Bandeja : System.Windows.Forms.UserControl, IEnumerable, IPósCargaSistema
	{
		...
		public Bandeja()
		{
            ...
            hashAgrupamento = new Dictionary<string, ISaquinho>();
		...
		/// o evento é disparado com parâmetor null. 
		/// </summary>
                    ...
                    if (!MostrarStatus)
                        ...
                        if (listaEntidades == null)
                            ...
                            foreach (ISaquinho s in listaEntidades)
                            {
                                ...
                                if (cotação != null)
                                    totalPreço += s.Mercadoria.CalcularPreço(cotação) * s.Quantidade;
                            }
                        }
                        else
                        {
		...
		protected virtual void AtualizaElementoListView(ISaquinho saquinho, ListViewItem item)
		{
            ...
            if (MostrarPreço)
            {
                double valorTotal = saquinho.Mercadoria.CalcularPreço(cotação) * saquinho.Quantidade;
        ...
        public void Adicionar(Entidades.ISaquinho saquinhoOriginal)
        {
            ...
            if (cotação != null)
                totalPreço += saquinhoOriginal.Mercadoria.CalcularPreço(cotação) * saquinhoOriginal.Quantidade;
            ...
            try
            {
                ...
                lock (listaSaquinhos)
                {
                    ...
                    foreach (ISaquinho s in listaSaquinhos)
                    {
                        ...
                        if (cotação != null)
                            totalPreço += sOuNovo.Mercadoria.CalcularPreço(cotação) * sOuNovo.Quantidade;
                    }
                }
            }
            finally
        ...
        private void InitializeComponent()
        {
            ...
            this.colPreçoUn = new System.Windows.Forms.ColumnHeader();
            this.colPreçoTot = new System.Windows.Forms.ColumnHeader();
            ...
            this.lista.Size = new System.Drawing.Size(473, 323);
            ...
            this.contextMenuStrip.Size = new System.Drawing.Size(198, 54);
            // 
            // mnuConsultar
            // 
            this.mnuConsultar.Image = global::Apresentação.Mercadoria.Properties.Resources.propriedades;
            ...
            // mnuExcluir
            // 
            this.mnuExcluir.Image = global::Apresentação.Mercadoria.Properties.Resources.Excluir;
            ...
            this.status.Size = new System.Drawing.Size(473, 21);
            ...
            this.barraFerramentas.Size = new System.Drawing.Size(473, 25);
            ...
            this.btnAgrupar.Image = global::Apresentação.Mercadoria.Properties.Resources.Icone___Janela_explicativa___ConfirmaçãoAgrupamento;
            ...
            this.btnSeparar.Image = global::Apresentação.Mercadoria.Properties.Resources.balança_pequena;
            ...
            this.Name = "Bandeja";
            this.Size = new System.Drawing.Size(473, 368);
