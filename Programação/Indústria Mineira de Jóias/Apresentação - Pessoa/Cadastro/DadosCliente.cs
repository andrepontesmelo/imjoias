        ...
        public Entidades.Pessoa.Pessoa Pessoa
        {
            ...
            set
            {
                ...
                if (value.DataRegistro.HasValue)
                    txtCadastro.Text = value.DataRegistro.Value.ToLongDateString();
                else
                    txtÚltimaVisita.Text = "<não registrado>";

                if (value.ÚltimaVisita.HasValue)
                    txtÚltimaVisita.Text = value.ÚltimaVisita.Value.ToLongDateString();
                else
                    txtÚltimaVisita.Text = "<não registrado>";
