...
//			País,
		...
		private void InitializeComponent()
		{
            ...
            // lblDescrição
            // 
            this.lblDescrição.Size = new System.Drawing.Size(568, 48);
            this.lblDescrição.Text = "Escolha o tipo de dado para realizar a procura e entre com o dado a ser procurado" +
                ".";
            // 
            // picÍcone
            // 
            ...
            this.label1.Text = "Dado procurado:";
            // 
            // cmbDado
            // 
            ...
            this.cmbDado.Size = new System.Drawing.Size(630, 21);
            ...
            this.btnOK.Location = new System.Drawing.Point(489, 522);
            ...
            this.btnCancelar.Location = new System.Drawing.Point(570, 522);
            ...
            this.txtProcura.Size = new System.Drawing.Size(630, 20);
            ...
            this.txtPessoa.Size = new System.Drawing.Size(630, 20);
                       ...
                       "Aguarde enquanto o sistema procura no banco de dados pelos dados fornecidos."))
            {
                ...
                switch (tipo)
                {
                    case TipoChave.Código:
                        ...
                        if (erro)
                            pessoas = new Entidades.Pessoa.Pessoa[] { };
                        else
                            pessoas = new Entidades.Pessoa.Pessoa[] { Entidades.Pessoa.Pessoa.ObterPessoa(código) };
                        break;
                    ...
                    case TipoChave.CPF:
                        pessoas = new PessoaFísica[] { PessoaFísica.ObterPessoaPorCPF(chave) };
                        break;
                    ...
                    case TipoChave.CNPJ:
                        pessoas = new PessoaJurídica[] { PessoaJurídica.ObterPessoaPorCNPJ(chave) };
                        break;
