...
namespace Apresentação.Pessoa.Consultas
{
	...
	public class ProcurarPessoaResultados : Apresentação.Formulários.JanelaExplicativa
	{
		...
		public ProcurarPessoaResultados(Entidades.Pessoa.Pessoa [] pessoas)
		{
		...
		private void Exibir(Entidades.Pessoa.Pessoa [] pessoas)
		{
            Aguarde janela = new Apresentação.Formulários.Aguarde("Este processo pode demorar", pessoas.Length, "Carregando cidades", "Experimente digitar o nome seguido de qualquer sobrenome, este processo será mais rápido da próxima vez.");
            janela.Abrir();
