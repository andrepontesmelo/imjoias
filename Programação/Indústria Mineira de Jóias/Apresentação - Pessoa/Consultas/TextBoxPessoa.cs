...
namespace Apresentação.Pessoa.Consultas
{
	...
	{
		// Constantes
		public const int alturaMínimaLista = 80;
		...
		private void InitializeComponent()
		{
            ...
            this.btnProcurar.BackgroundImage = global::Apresentação.Pessoa.Properties.Resources.search4people;
            ...
            this.imagem.Image = global::Apresentação.Pessoa.Properties.Resources.Lupa;
		...
		/// <summary>
		/// Pessoa selecionada. Pode ser null.
		/// </summary>
        [Browsable(false)]
        ...
        private delegate void RecuperaçãoCallback(Entidades.Pessoa.Pessoa[] pessoas);

		/// <summary>
		/// Ocorre quando o coletor recupera nomes
		/// </summary>
		/// <param name="nomes">Nomes recuperados da camada de acesso</param>
		private void Recuperação(Entidades.Pessoa.Pessoa [] pessoas)
		{
            try
            {
                ...
                else
                {
                    ...
                    refPessoas = new Hashtable(pessoas.Length);
				...
				switch (e.KeyCode)
				{
					...
					case Keys.Enter:
                        if (somenteCadastrados && lista.Items.Count > 0)
                        {
                            ...
                            Entidades.Pessoa.Pessoa[] pessoas = Entidades.Pessoa.Pessoa.ObterPessoas(txt.Text.Trim());
		...
		private void txt_Leave(object sender, System.EventArgs e)
		{
            ...
            if (pessoa == null && funcionários && txt.Text.Length != 0 && lista.Items.Count > 0)
                AoSelecionar(lista.Items[0]);
            else if (somenteCadastrados && !Focused && txt.Text.Length > 0 && Pessoa == null)
                ProcurarPessoaAssincronamente();
            else if (Código.HasValue && Pessoa == null)
                ProcurarPessoaAssincronamente();
            else if (Deselecionado != null && Pessoa == null)
