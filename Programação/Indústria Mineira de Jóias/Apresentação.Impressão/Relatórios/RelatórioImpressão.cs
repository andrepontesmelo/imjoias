    ...
    class RelatórioImpressão : IDisposable
    {
        ...
        private void PrepararPedido(DadosRelatório dados) //, DateTime início, DateTime fim)
        {
            ...
            pedidos = dados.ApenasConsertos ?
                    Entidades.Pedido.ObterConsertosRecebidos(dados.PeríodoInicial, dados.PeríodoFinal, dados.PeríodoPrevisão, true)
                    : Entidades.Pedido.ObterEncomendasRecebidas(dados.PeríodoInicial, dados.PeríodoFinal, dados.PeríodoPrevisão, true);
