...
namespace Apresentação.Impressão.Relatórios.Acerto
{
    public class ControleImpressãoAcerto
    {
        ...
        /// </summary>
        protected void MapearItem(DataRow linha, SaquinhoAcerto s, ControleAcertoMercadorias acerto)
        {
        ...
        /// </summary>
        protected void MapearInformações(DataRow linha, ControleAcertoMercadorias acerto)
        {
