...
namespace Apresentação.Financeiro
{
    public partial class BaseEditarRelacionamento : Apresentação.Formulários.BaseInferior
    {
        ...
        /// </summary>
        public delegate void TravaAlteradaHandler(BaseEditarRelacionamento sender, Relacionamento e);
        ...
        public virtual void Abrir(Entidades.Relacionamento.Relacionamento relacionamento)
        {
            ...
            if (relacionamento.AcertoConsignado != null && relacionamento.AcertoConsignado.Acertado)
        ...
        protected override void AoSerSubstituído(BaseInferior novaBase)
        {
            ...
            else if (Relacionamento.AcertoConsignado != null
                && Relacionamento.AcertoConsignado.Contém(Relacionamento))
        ...
        private void opçãoImprimir_Click(object sender, System.EventArgs e)
        {
            ...
            //Apresentação.Formulários.JanelaImpressão janela = CriarJanelaImpressão();
            ...
            //    // Assegurar que os controles encontram-se travados.
            //    if (entidade.Travado)
        ...
        private void btnExcluir_Click(object sender, EventArgs e)
        {
            if (entidade.Cadastrado)
            {
                    ...
                    MessageBoxDefaultButton.Button2) == DialogResult.Yes)
                {
                    //if (MessageBox.Show(
                    //    ParentForm,
                    //    "Somente exclua um documento se ele estiver errado e não tiver sido utilizado em nenhum momento.\n\nNão seria importante manter este documento?",
                    //    "Excluir documento",
                    //    MessageBoxButtons.YesNo, MessageBoxIcon.Question,
                    ...
                    //    if (MessageBox.Show(
                    //        ParentForm,
                    //        "ATENÇÃO!!!\n\nEsta é uma operação irreversível. Deseja mesmo excluir o documento?",
                    //        "Excluir documento",
