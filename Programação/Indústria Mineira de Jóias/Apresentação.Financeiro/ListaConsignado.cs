...
namespace Apresentação.Financeiro
{
    public partial class ListaConsignado : UserControl
    {
        ...
        private Dictionary<ListViewItem, Entidades.Relacionamento.Relacionamento> hashListViewItemConsignado;   // Chave: item da list view
        private Dictionary<Entidades.Relacionamento.Relacionamento, ListViewItem> hashConsignadoListViewItem;   // Chave: Relacionamento (objeto de contexto)
        ...
        public ListaConsignado()
        {
            ...
            hashListViewItemConsignado = new Dictionary<ListViewItem, Entidades.Relacionamento.Relacionamento>();
            hashConsignadoListViewItem = new Dictionary<Entidades.Relacionamento.Relacionamento, ListViewItem>();
        ...
        public Entidades.Relacionamento.Relacionamento ItemSelecionado
        {
            get
            {
        ...
        [DefaultValue(true)]
        [Description("Exibe apenas documentos não acertados. Caso contrário, marca em cinza os já acertados.")]
        ...
        public virtual void Carregar(Entidades.Pessoa.Pessoa pessoa, DateTime início, DateTime fim)
        {
            ...
            try
            {
                ...
                foreach (Entidades.Relacionamento.Relacionamento relacionamento in listaRelacionamentos)
        ...
        protected virtual ArrayList ObterRelacionamentos(Entidades.Pessoa.Pessoa pessoa, DateTime início, DateTime fim, bool apenasAcertados)
        {
        ...
        protected virtual ListViewItem AdicionarItem(Entidades.Relacionamento.Relacionamento relacionamento)
        {
            ListViewItem item;
            ...
            hashConsignadoListViewItem.Add(relacionamento, item);
        ...
        private ListViewGroup ObterGrupo(Entidades.Relacionamento.Relacionamento relacionamento)
        {
            ListViewGroup grupo;
        ...
        {
            if (!hashConsignadoListViewItem.ContainsKey(relacionamento))
                throw new Exception("Não foi possível encontrar list-view-item relacionado com entidade relacionamento na hash");

            ListViewItem item = hashConsignadoListViewItem[relacionamento];

            // Remove das tabelas-hash
            hashConsignadoListViewItem.Remove(relacionamento);
        ...
        /// </example>
        protected virtual void PrepararListViewItem(ListViewItem item, Entidades.Relacionamento.Relacionamento relacionamento)
        {
            if (relacionamento.AcertoConsignado != null)
        ...
        internal void AoMudarTrava(Entidades.Relacionamento.Relacionamento consignado)
        {
            foreach (ListViewItem item in lista.Items)
