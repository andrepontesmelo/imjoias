...
namespace Apresentação.Financeiro
{
    ...
    public class BaseConsignado : Apresentação.Formulários.BaseInferior
    {
        ...
        protected void Criar()
        {
            ...
            if (acerto.TabelaPreço != null)
                relacionamento.TabelaPreço = acerto.TabelaPreço;
        ...
        private void InitializeComponent()
        {
            ...
            this.opçãoNovoRelacionamento.Imagem = global::Apresentação.Financeiro.Properties.Resources.novo;
            ...
            this.opçãoAbrirSeleção.Imagem = global::Apresentação.Financeiro.Properties.Resources.openfolderHS;
            ...
            this.opçãoExcluír.Imagem = global::Apresentação.Financeiro.Properties.Resources.Excluir;
        ...
        /// </summary>
        private void TravaAlterada(BaseEditarRelacionamento sender, Entidades.Relacionamento.Relacionamento e)
        {
            ListaConsignado lista = ObterLista();
        ...
        private void opçãoMoverAcerto_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    foreach (Relacionamento relacionamento in ObterLista().ObterDocumentosMarcados())
                    {
