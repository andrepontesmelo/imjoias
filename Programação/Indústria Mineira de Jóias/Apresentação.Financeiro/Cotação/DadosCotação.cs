            ...
            set
            {
                ...
                if (moeda != null)
                {
                    ...
                    if (moeda.Ícone != null)
                        ...
                        picMoeda.Image = Properties.Resources.moeda;
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (!double.IsInfinity(variação))
                    {
                        ...
                        if (variação >= 0)
                        {
                            picVariação.Image = Properties.Resources.VariaçãoPositiva;
                            lblVariação.ForeColor = Color.Green;
                        }
                        else
                        {
                            picVariação.Image = Properties.Resources.VariaçãoNegativa;
