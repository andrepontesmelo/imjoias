...
using Apresentação.Álbum.Edição.Properties;
    ...
    public partial class ListaFotos : UserControl, IDisposable
    {
        ...
        public List<Foto> Fotos
        {
            ...
            set
            {
                ...
                imagens.Images.Add("logo", Foto.Redesenhar(Resources.Logo, imagens.ImageSize.Width, imagens.ImageSize.Height));
        ...
        private void RecuperarImagem(Foto foto)
        {
            ...
            catch (ArgumentOutOfRangeException erroEstranho)
            {
                existe = false;
            }
