...
namespace Apresentação.IntegraçãoSistemaAntigo
{
	public class Principal : Apresentação.Formulários.BaseFormulário
	{
		...
		private void InitializeComponent()
		{
            ...
            botão2.Imagem = global::Apresentação.IntegraçãoSistemaAntigo.Properties.Resources.rodízio;
            botão2.Ordenação = 0;
            botão2.Texto = "Código de Barras";
            botão3.Imagem = ((System.Drawing.Image)(resources.GetObject("botão3.Imagem")));
            botão3.Ordenação = 0;
            botão3.Texto = "Cadcli";
            botão4.Imagem = global::Apresentação.IntegraçãoSistemaAntigo.Properties.Resources.rodízio;
            botão4.Ordenação = 0;
            botão4.Texto = "Pagamentos";
            botão5.Imagem = global::Apresentação.IntegraçãoSistemaAntigo.Properties.Resources.rodízio;
            botão5.Ordenação = 0;
            botão5.Texto = "Consignado";
            botão6.Imagem = global::Apresentação.IntegraçãoSistemaAntigo.Properties.Resources.rodízio;
            botão6.Ordenação = 0;
            botão6.Texto = "Vendas";
            botão7.Imagem = global::Apresentação.IntegraçãoSistemaAntigo.Properties.Resources.rodízio;
            botão7.Ordenação = 0;
            botão7.Texto = "Fiscal";
