...
namespace Apresentação.IntegraçãoSistemaAntigo
{
	public class BaseMercadorias : Apresentação.Formulários.BaseInferior
	{
		...
		private void InitializeComponent()
		{
            ...
            this.quadroErros.Location = new System.Drawing.Point(192, 183);
            this.quadroErros.MostrarBotãoMinMax = false;
            this.quadroErros.Name = "quadroErros";
            this.quadroErros.Size = new System.Drawing.Size(440, 348);
            ...
            this.lstErros.Size = new System.Drawing.Size(424, 394);
            ...
            this.quadroDiretório.Size = new System.Drawing.Size(440, 169);
            ...
            this.label5.Size = new System.Drawing.Size(408, 48);
            ...
            this.lblCotaçãoVarejo.Location = new System.Drawing.Point(6, 123);
            this.lblCotaçãoVarejo.Name = "lblCotaçãoVarejo";
            this.lblCotaçãoVarejo.Size = new System.Drawing.Size(429, 38);
		...
		private void button1_Click(object sender, System.EventArgs e)
		{
			...
			using (Apresentação.Formulários.Aguarde aguarde = new Apresentação.Formulários.Aguarde("Recuperando mercadorias do novo bd para que sejam atualizadas", 7, "Transpondo banco de dados", "Aguarde enquanto o banco de dados é sincronizado."))
			{
				Dbf dbf = null;
				...
				try
				{
					...
					aguarde.Passo("Obtendo mercadorias do dbf"); aguarde.Refresh();
					dsVelho = dbf.ObterDataSetMercadoria();
				} 
				catch (Exception f)
				{
                    aguarde.Close();
                    MessageBox.Show("Os dbf necessários não foram abertos" + f.Message);
					return;
				}

                aguarde.Passo("Transpondo componente de custo");
                new Controles.Mercadorias.ComponenteDeCusto(ErroFunção, dsVelho, dsNovo, dbf).Transpor();

                aguarde.Passo("Transpondo cadastro de mercadorias");
                new Controles.Mercadorias.Mercadorias(ErroFunção, dsVelho, dsNovo, dbf).Transpor();
                ...
                new Controles.Mercadorias.VinculoMercadoriaComponenteCusto(ErroFunção, dsVelho, dsNovo).Transpor();

                aguarde.Close();

                //aguarde.Passo("Enviando dados para servidor e esperando por atualização"); aguarde.Update();
