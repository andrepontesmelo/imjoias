...
//			if (Entidades.Setor.ObterSetor(this.funcionário.Setor).Atendimento)
				//InserirBaseInferior(new Apresentação.Usuário.InterForm.Atendimento.BaseClientes(funcionário));
//			else
				InserirBaseInferior(new BaseUsuário(funcionário));
