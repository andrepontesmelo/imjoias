...
namespace Apresentação.Impressão.Cliente
{
    ...
    public class ControleImpressão : Comunicador<ControleImpressão>
    {
        ...
        /// Hash de candidatos.
        /// </summary>
        private Dictionary<string, DadosCandidatura> hashCandidatos = new Dictionary<string, DadosCandidatura>(StringComparer.Ordinal);
        private Dictionary<string, EndPoint> hashEndPoint = new Dictionary<string, EndPoint>(StringComparer.Ordinal);
