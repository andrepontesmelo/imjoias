...
namespace Apresentação.Pessoa
{
	...
	///	553134220815 -> 12 digitos -> +55 (31) 3422-0185
    ///
    /// 2015: Novo formato com acréscimo de um dígito:
    /// 31892282842 -> 11 dígitos  (31) 99228-2842
    /// 892282842 ->    9 digitos  89228-2842
    ///	5531892282842 -> 13 digitos -> +55 (31) 83422-0185
    /// </summary>
	public class TxtTelefone : System.Windows.Forms.UserControl
	{
		...
		private static string ColocarTraços(string telefone) 
		{
			string novoTelefone = "";
            ...
            else
            {
                ...
                {
                    novoTelefone = telefone.Substring(telefone.Length - 4, 4) + (!String.IsNullOrEmpty(novoTelefone) ? "-" : "") + novoTelefone;
                    telefone = telefone.Substring(0, telefone.Length - 4);
                }
                
                novoTelefone = telefone + ((telefone.Length > 1) ? "-" : "") + novoTelefone;
            }
		...
		/// <returns></returns>
		private static string LimparCaracteres(string antigo) 
		{
			string novo = "";
