...
namespace Apresentação.Financeiro
{
    class ListaConsignadoOrdenador : IComparer
    {
        ...
        /// </summary>
        private Dictionary<ListViewItem, RelacionamentoAcerto> hashItemRelacionamento;
        ...
        /// </summary>
        public ListaConsignadoOrdenador(Dictionary<ListViewItem, RelacionamentoAcerto> hashItemRelacionamento)
        {
