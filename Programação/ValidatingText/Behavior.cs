 ...
 * This file contains all Behavior classes.
 * 
...
namespace AMS.TextBox
{
	...
	{		
		...
		{
			MessageBox.Show(m_textBox, message, Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
		}
		...
		public virtual bool Validate(int flags, bool setFocusIfNotValid)
		{
			...
			if ((flags & (int)ValidatingFlag.Max_IfInvalid) != 0 && !IsValid())
			{
        ...
        protected void SendKeyLeft()
        {
            if (m_textBox.SelectionStart > 0)
                m_textBox.SelectionStart--;

            m_textBox.SelectionLength = 0;
        }

        protected void SendKeyRight()
        {
            m_textBox.SelectionStart++;
            m_textBox.SelectionLength = 0;
        }

        protected void SendKeys(string txt)
        {
            m_noTextChanged = true;
            m_textBox.SelectionLength = 0;
            m_textBox.SelectedText = txt;
        }
    } 	
