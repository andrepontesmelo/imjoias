<%@ Page language="c#" Codebehind="bug.aspx.cs" AutoEventWireup="false" Inherits="bugs.bug" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<HR style="Z-INDEX: 102; LEFT: 16px; POSITION: absolute; TOP: 96px; HEIGHT: 8px" width="100%"
				SIZE="8">
			<DIV style="Z-INDEX: 103; LEFT: 16px; WIDTH: 696px; POSITION: absolute; TOP: 112px; HEIGHT: 200px"
				ms_positioning="FlowLayout">
				<%
					Detalhar(Request["codigo"]);
				%>
			</DIV>
		</form>
	</body>
